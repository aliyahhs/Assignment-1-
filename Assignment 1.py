...
class Entrance(enum.Enum):              #Type of entrence when entering the airport (VIP, or Regular enterence)
    VIP = 1
    Regular = 2
...
class AirPort:                      #Class #4
    ...
    def __init__(self, airlineComp, gateNum, terminalNum, transportServ, entrance):
        '''Initialize the attributes of the class'''
    ...
    def setEntrance(self, entrance):           #Set the entrance type (VIP, Business)
        self.__entrance = entrance

    def getEntrance(self):             #Get the entrance type
...
'''Ceated an object by filling the first passenger detail in PassengerDetail Class'''

passenger2 = Passenger(2, ClassType.FirstClass, "06 Dec 20", "Chicago ORD", "New York JFK")
'''Ceated an object by filling the first passenger detail in Passenger Class'''

passenger3 = Flight("NA4321", "09A", "11:40", "11:20", "13:30")
'''Ceated an object by filling the first passenger detail in Flight Class'''

passenger4= AirPort("National Airline", "03", 2, TransportService.GulfCar, Entrance.VIP)
'''Ceated an object by filling the first passenger detail in Airline Class'''

passenger5= Ticket(629, "598.9$", "24A" , YorN.Yes, "5A6BCD78", "Passenger ticket and Baggage check")
'''Ceated an object by filling the first passenger detail in Ticket Class'''
...
print("Entrance Type:", passenger4.getEntrance())
